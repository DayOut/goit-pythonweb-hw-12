...
async def test_get_upcoming_birthdays(client, monkeypatch, auth_headers):
    ...
    print("[DEBUG] test_get_upcoming_birthdays !!!")

    mock_get_current_user = AsyncMock(return_value=user_data)
...
async def test_get_upcoming_birthdays_unauthenticated(client, monkeypatch):
    ...
    print("[DEBUG] test_get_upcoming_birthdays_unauthenticated !!!", response)
